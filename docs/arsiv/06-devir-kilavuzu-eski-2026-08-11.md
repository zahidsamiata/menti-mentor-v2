> 🗄️ **ARŞİV KOPYASI (2026-09-24, DC turu).** `docs/devir/06-devir-kilavuzu.md` bu tarihte yeniden yazıldı; eski gövde
> **harfi harfine** aşağıda korunuyor (son commit: `dfb2fe4`). Güncel giriş belgesi: `docs/devir/06-devir-kilavuzu.md`.
