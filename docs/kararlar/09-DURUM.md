...
> **⚡ ŞU AN — MERGE TURU SNAPSHOT (2026-08-26, git doğrulandı):** Dört PR MERGED → **çatı main HEAD `71bac0c`** (#116 + #117), **backend main HEAD `b433554`** (#53 `2caa7bb` + #54). **Submodule pointer bump PR AÇIK** (`chore/pointer-bump-53-54`: `838d128`→`b433554`, ileri-sarım — **merge PO'da**). İki repo main CI **yeşil.**
...
> · **Açık PR (şu an):** yalnız `chore/pointer-bump-53-54` (bu tur açıldı, merge PO'da) + **#110** (analytics, 🛑 kilitli). Diğer 4 iş PR'ı MERGED.
