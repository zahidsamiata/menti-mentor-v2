...
| **87** | Onaylanan kalibrasyon önerisi scoring'de okunmuyordu (ölü yazma) | ölü-kod | 9b ile bağlandı | **🔀 ÇÖZÜLDÜ backend PR #52 (MERGE OLMADI)** — motor artık kaydedilen ağırlığı okur |
