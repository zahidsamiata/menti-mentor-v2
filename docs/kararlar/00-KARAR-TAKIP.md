...
| S33 | Faz 5 promptu yazılırken **6 KARAR NOKTASI** (keşif §G) PO'ya sorulacak — özellikle "skor hangi alana yazılacak (`oceanO..N` mi `discD..C` mi)" ve "canlı `matching.ts` mi uykudaki `rankMentorsForMenti` mi". | 2026-09-04 | ⬜ BEKLİYOR | 101 / Faz 5 · `faz5-onkosul-kesfi-2026-09-04.md` §G |
