...
| **KVKK metinleri** | Aydınlatma/gizlilik/çerez metni **taslak → gerçek/hukuki** | Yasa EVET: gerçek PII taslak metinle toplamak KVKK ihlali. **✅ TASLAK PAKET HAZIR** (`konu/kvkk-metinleri/`, 9 belge + **profesyonel `.docx`** avukata sunum) → **kalan: hukukçu onayı + [PO DOLDURACAK].** ⚠️ **FE site-entegrasyonu PO kararıyla İPTAL** (metinler siteye çıkarılmadan avukata Word ile gidilecek; sayfalara gömme **hukukçu onayı sonrasına** ertelendi — silme yok) | KT:140; envanter | — | madde 90 (migration) | **Tur-0 (PO+hukukçu)** |
