...
72. **🔵❓ Sertifika baraj "0 puan" kuralı yalnız `isRedLine`'da** — ~~[ESKİ · 2026-09-04] "tüm sorularda mı" kararı yok~~ **✅ KARARA BAĞLANDI (2026-09-04, PO): seçenek (c)** — red-line ilk-deneme `!==3` eler + diğer konularda %80-KONU eşiği (kod zaten uyguluyor: `certification.service.ts:12/50/66`). Eşik KONU bazlı (8→7), PUAN değil. ⬜ toplam eşiği kalibrasyonu (içeriği bloklamaz). detay: Bölüm F.2 (T4) + `../raporlar/kesif/faz5-onkosul-kesfi-2026-09-04.md` §I.
