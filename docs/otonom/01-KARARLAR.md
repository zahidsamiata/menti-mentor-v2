...
|---|---|:---:|---|
| KARAR-11 | Kullanılmayan/mükerrer kod ne olsun | **2** (K-13, E-5) | ✅ **CEVAPLANDI (2026-09-21): A** · 📦 tam metin: `docs/otonom/arsiv/01-KARARLAR-cevaplanmis.md`|
| KARAR-22 | Mentör reddederken ne olsun (ret deneyimi) | 1 (P-05) | ✅ **CEVAPLANDI (2026-09-21): B** · ⚠️ e-posta ayağı SMTP bekler · 📦 tam metin: `docs/otonom/arsiv/01-KARARLAR-cevaplanmis.md`|
| KARAR-1 | Randevu format/süre kim belirler | 1 (K-15) | ✅ **CEVAPLANDI (2026-09-21): A** · ⛔ migration + yedek + PO onayı · 📦 tam metin: `docs/otonom/arsiv/01-KARARLAR-cevaplanmis.md`|
...
| KARAR-6 | Menti tüm mentörleri görsün mü | 1 (K-19 içerik) | ✅ **CEVAPLANDI (2026-09-21): A** · + alt uyum eşiği · 📦 tam metin: `docs/otonom/arsiv/01-KARARLAR-cevaplanmis.md`|
| KARAR-7 | Online toplantı linkini kim girer | 1 (K-19 içerik) | ✅ **CEVAPLANDI (2026-09-21): A** · 📦 tam metin: `docs/otonom/arsiv/01-KARARLAR-cevaplanmis.md`|
| KARAR-10 | OCEAN/SJT psikometri motoru | 1 (F-11) | ✅ **CEVAPLANDI (2026-09-21): C** · ⭐ AŞAMALI (3 aşama, feature flag) · 📦 tam metin: `docs/otonom/arsiv/01-KARARLAR-cevaplanmis.md`|
| KARAR-19 | KVKK geri-dönülmez yetkiler kümesi | 1 (F-07) | ⬜ boş · ⚠️ ağustos G1-15/16/29 ✅ işleme-al |
| KARAR-20 | Mentör menti talebini reddedebilsin mi | 1 (F-17) | ✅ **CEVAPLANDI (2026-09-21): A** · 📦 tam metin: `docs/otonom/arsiv/01-KARARLAR-cevaplanmis.md`|
...
| KARAR-23 | Kurum bildirimleri açılsın mı (onay/ret/düzeltme maili) | 1 (U-04) | ✅ **CEVAPLANDI (2026-09-21): ÖZEL — onay+düzeltme maili, ret maili YOK** · 📦 tam metin: `docs/otonom/arsiv/01-KARARLAR-cevaplanmis.md`|
| KARAR-24 | Hata iz kaydı (stack) panele açılsın mı | 0 (V-02 kısmı) | ✅ **CEVAPLANDI (2026-09-21): B — PII temizlenmiş** · 📦 tam metin: `docs/otonom/arsiv/01-KARARLAR-cevaplanmis.md`|
...
| KARAR-27 | Dış hata izleme servisi kurulsun mu | 0 | ✅ **CEVAPLANDI (2026-09-21): A — Sentry, PII temizleme + KVKK metni** · 📦 tam metin: `docs/otonom/arsiv/01-KARARLAR-cevaplanmis.md`|
| KARAR-28 | Ölü LLM/OpenAI env silinsin mi | 0 | ⬜ boş · Bölüm 4 · SİLME PROTOKOLÜ |
| KARAR-29 | Öğrenme yolculuğu diğer şık açıklamaları gösterilsin mi | 1 (K-06) | ✅ **CEVAPLANDI (2026-09-21): A** · 📦 tam metin: `docs/otonom/arsiv/01-KARARLAR-cevaplanmis.md`|
| KARAR-0 | Merge politikası | — | ✅ CEVAPLANDI · 📦 tam metin: `docs/otonom/arsiv/01-KARARLAR-cevaplanmis.md`|
| KARAR-18 | PO-manuel işler listesi (onay değil) | — | — (hatırlatma) |
| **KARAR-53** | **Menti müsait olmayan saati önerebilsin mi** (booking ↔ müsaitlik çelişkisi) | **1** (K-05) ⛔ çıkış blokeri | ✅ **CEVAPLANDI (2026-09-23): ÖZEL — mentörün 4 hâli** (blok=kat+takvim · koşul=esnek · meşgul=soluk/mesaj · boş=dürt+eskalasyon); KARAR-1 ile TEK migration · 📦 tam metin: `docs/otonom/arsiv/01-KARARLAR-cevaplanmis.md`|
...
| **KARAR-34** | **Kulüp tipi kurum + kurumlar arası görünürlük** | **3** (md.91·115·116) | ✅ **CEVAPLANDI (2026-09-23): ÖZEL — topluluk lideri modeli** (lider onaylanır, üyeler değil; lider=veri sorumlusu) + kayıt ekranı zorunlu/isteğe-bağlı + SORU2→B anonim toplu; ⛔ AVUKAT · 📦 tam metin: `docs/otonom/arsiv/01-KARARLAR-cevaplanmis.md`|
...
| **KARAR-32** | **Mentör kendini havuzdan çekebilsin mi** | **2** (Y-15, `mentorVisibilityEnabled`) | ✅ **CEVAPLANDI (2026-09-23 REVİZYON): havuzdan ÇIKMAZ — soluk görünür, yalnız mesaj, randevu almaz** (KARAR-53 ③); ~~2026-09-21: A~~ · 📦 tam metin: `docs/otonom/arsiv/01-KARARLAR-cevaplanmis.md`|
| **KARAR-33** | **Kurumdan üye çıkarma + red tipi** | **2** (Y-14/md.36, md.35) | ✅ **CEVAPLANDI (2026-09-21): B — dondur, sebep seç, 30 gün sonra psikometri sil** · 📦 tam metin: `docs/otonom/arsiv/01-KARARLAR-cevaplanmis.md`|
...
| **KARAR-66** | **"Akıllı eşleştirme" iddiası — ölç mü geri çek mi** | **2** (PP:248 C2) | ✅ **CEVAPLANDI (2026-09-23): B — iddia geri çekilir, "YÖNLENDİRME"** · 📦 tam metin: `docs/otonom/arsiv/01-KARARLAR-cevaplanmis.md` |
...
| **KARAR-69** | **"ÇIKIŞ" tanımı ne** | **0** (tüm çıkış-blokeri etiketlerini geçerli kılar) | ✅ **CEVAPLANDI (2026-09-23): A+B — ilk kurum + KVKK tabanı; ölçek hukuku ertelenir** · 📦 tam metin: `docs/otonom/arsiv/01-KARARLAR-cevaplanmis.md` |
| **KARAR-70** | **Gerçek kullanıcı görüşmesi: ne zaman, kaç kişi** | **1** (görüşme kılavuzu · PP:334,337) | ✅ **CEVAPLANDI (2026-09-23): C sonra B + sistem-içi otomatik soru** · 📦 tam metin: `docs/otonom/arsiv/01-KARARLAR-cevaplanmis.md` |
...
**Kullanıcı ne görür:** Kayıt ekranında (e-postayla kayıt ve Google/LinkedIn ile kayıt) tek bir "KVKK'yı onaylıyorum" kutusu yerine ayrı ayrı rıza kutuları: 4 zorunlu (DISC ile eşleştirme · yurt dışında saklama · veri işleme · anonim iyileştirme) + 2 isteğe bağlı (kurumlar arası paylaşım · OCEAN kişilik profili). Kanıt: backend PR `menti-mentor#142` (`src/services/consentService.ts`), çatı PR `menti-mentor-v2#320`.
...
**Durum:** kod hazır · CI yeşil · bağımsız inceleme: henüz yapılmadı (EVET gelirse merge öncesi ZORUNLU yapılır) · ⚠️ metinler yer tutucudur, yayın metni avukat onayına bağlı (03-PO-ELLE-ISLER avukat paketi).
...
**Durum:** kod hazır · CI yeşil (backend +7, çatı +6 test) · bağımsız inceleme: henüz yapılmadı (EVET gelirse merge öncesi ZORUNLU yapılır).
**EVET** → ajan tarihli yedeği alır → merge → canlı kontrol. (Bu ortamda DB erişimi yoksa: "EVET var, yedek için tek seferlik DB erişimi gerekiyor" diye `00-SIMDI`'ye yazar ve bekler.)
