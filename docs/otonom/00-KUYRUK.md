...
| P-07 | Ş1 | **Küçük başarı/kilometre taşı kutlaması yok.** Menti 1. ve 10. görüşmede aynı jenerik "🎉 Teşekkürler". "İlk görüşmeni tamamladın!" gibi sayıya bağlı kutlama yok. | 🟡 | Menti kilometre taşlarında kişiye özel kutlama görüyor | BEKLIYOR | =M6 (⬜). Kanıt: `meeting-checkin/page.tsx:81-88` jenerik; milestone/streak 0 sonuç. Efor M |
...
| P-10 | Ş4 | **Mentör bildirim/e-posta ulaşmıyor.** Talep tetikleyicisi var ama push STUB; canlı booking yolu (`/meetings/book`) e-posta da göndermiyor. Mentör talebi ancak paneli açınca öğreniyor. | 🟡 | Mentör yeni talepte bildirim/e-posta alıyor | BEKLIYOR | =MT5. Kanıt: `notificationService.ts:39-55` `[PUSH-STUB]`; e-posta yalnız `createMeeting:199`, `book:514-531`'de yok. Mevcut G5-07 push stub ile ilişkili. Efor M |
| P-11 | Ş0 | **Emek "kaç saat" görünmüyor.** "Kaç menti/görüşme" var, "kaç saat mentörlük" yok; "bu dönem" çerçevesi yok, dört çıplak sayı. | 🟡 | Mentör toplam mentörlük saatini/dönem emeğini görüyor | BEKLIYOR | =MT6. Kanıt: `durationMin` yalnız süper-admin metriğinde (`adminSettingsController.ts:258-262`), panelde 0 tüketici. Efor M |
| P-12 | Ş0 | **Sertifika rozeti kalıcı değil.** Sertifikalı mentör ertesi gün panelde hâlâ "Sertifikaya başla →" görüyor. | 🟡 | Sertifikalı mentör panelde kalıcı rozet görüyor | BEKLIYOR | =MT7/BY-3. Kanıt: rozet yalnız sınav-sonu (`certification/page.tsx:189-200`); panel CTA `mentor/page.tsx:172-184` koşulsuz; "benim sertifika durumum" ucu yok. Backend uç gerekebilir. Efor M |
| P-13 | Ş0 | **"Şu an kime mentörlük yapıyorum" listesi panelde yok.** "Aktif Mentilerim" yalnız sayı; menti listeleyen bileşen yok. | 🟡 | Mentör aktif mentilerini panelde listeleyebiliyor | BEKLIYOR | =MT9. Kanıt: `mentor/page.tsx:39` yalnız sayı. Efor M |
| P-14 | Ş0 | **Mentöre takdir/teşekkür cümlesi yok.** "Kendi etkim" tamamen sayısal; emeği anlatan tek cümle yok (tek olumlu dönüş NPS sayısı, veri yoksa "—"). | 🟡 | Mentör emeğini anlatan takdir mesajı görüyor | BEKLIYOR | =MT10. Kanıt: mentör dosyalarında takdir/teşekkür/etki 0 eşleşme. İçerik/UX. Efor S |
